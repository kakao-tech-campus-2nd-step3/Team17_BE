...
public enum AuthErrorType implements ErrorType {
    ...
    HOME_TRY_SERVER_EXCEPTION("Auth500_001", HttpStatus.INTERNAL_SERVER_ERROR, "서버 인증 기능에 예상치 못한 에러가 발생하였습니다"),
    KAKAO_AUTH_SERVER_EXCEPTION("Auth500_002", HttpStatus.INTERNAL_SERVER_ERROR, "카카오 서버에 의한 에러가 발생하였습니다.");

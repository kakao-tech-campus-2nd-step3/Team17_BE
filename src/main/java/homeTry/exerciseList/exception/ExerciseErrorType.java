...
public enum ExerciseErrorType implements ErrorType {
    ...
    // 운동 이름이 공백일 때 - 400
    EXERCISE_NAME_BLANK_EXCEPTION("Exercise400_006", HttpStatus.BAD_REQUEST, "운동 이름은 필수입니다."),
    // 운동 이름이 너무 길 때 - 400
    EXERCISE_NAME_TOO_LONG_EXCEPTION("Exercise400_007", HttpStatus.BAD_REQUEST, "운동 이름은 최대 20자까지 가능합니다."),
    // 운동에 대한 권한이 없을 때 - 403

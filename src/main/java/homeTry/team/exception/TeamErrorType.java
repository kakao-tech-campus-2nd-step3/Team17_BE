...
public enum TeamErrorType implements ErrorType {
    ...
    ALREADY_JOINED_EXCEPTION("Team409_002", HttpStatus.CONFLICT, "이미 해당 멤버는 팀에 가입되어 있습니다"),
    TEAM_HAS_NOT_PASSWORD_EXCEPTION("Team400_001", HttpStatus.BAD_REQUEST, "해당 팀에는 비밀번호가 없습니다"),
    INVALID_PASSWORD_EXCEPTION("Team401_002", HttpStatus.UNAUTHORIZED, "비밀번호가 틀렸습니다");

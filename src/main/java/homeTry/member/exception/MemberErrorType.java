...
public enum MemberErrorType implements ErrorType {
    ...
    DB_UNIQUE_KEY_VIOLATON_EXCEPTION("Member500_001", HttpStatus.INTERNAL_SERVER_ERROR,
            "서버 Member DB에 에러가 발생하였습니다"),
    UNKNOWN_FATAL_EXCEPTION("Member500_002", HttpStatus.INTERNAL_SERVER_ERROR,
            "서버 Member 기능에 예상치 못한 에러가 발생하였습니다");
